...
<script>
	...
	{
		if(!memberchk.name.value)
		{
			alert("이름을 입력하세요.");
			return false;
		} 
		
		if(!memberchk.jb1.value || !memberchk.jb2.value)
		{
			alert("주민 번호를 입력하세요.");
			return false;
		} 
		
		var jb = memberchk.jb1.value + memberchk.jb2.value;
...
<body>
	<div style="text-align:center; font-family:LotteMartHappy; font-size:30px">
      ...
      <hr>
      <br>
      <form action="memberChk.do" name="memberchk">
         <table border="0" align=center>
            <tr>
               <th align=left>이름</th>
            </tr>
            <tr>
               <td align=left><input type="text" name="name" placeholder=" 이름" style="border-radius:5px; width:90%; height:25px"></td>
            </tr>
         ...
         <table border="0" align=center>
            <tr>
                <td align="center" colspan=2><input type="button" value="회원확인" style="border-radius:5px;" onclick="checkmember();"></td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	...
	<c:if test="${sessionScope.memberchk == '있음' }">
		<% session.setAttribute("memberchk", null); %>
		<script>
			setTimeout(function()
			{
				alert("이미 있음");
...
<h2 class="align-center">회원 여부 확인</h2>
<hr width="300">

 <form action="memberChk.do" name="memberchk" method="post">
<table align="center">
<tr>
<td>이름&nbsp;</td>
</tr>
...
<table border="0" align=center>
            <tr>
                <td align="center" colspan=2><input type="button" value="확인" class="btn btn-primary" style="background:#5b98de" onclick="checkmember();"></td>
                <td>&nbsp;</td>
